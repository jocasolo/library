...
public interface UserDAO extends CrudRepository<User, Integer> {
	...
	public List<UserDTO> search(@Param("dni") String dni, @Param("name") String name, @Param("surname") String surname,
			Pageable pageable);
	
	@Query(value = "SELECT u.status FROM User AS u WHERE id = :id")
	public UserEnum findStatus(@Param("id") Integer id);
